...
### Q21: What is Piping in Node? ☆☆☆☆

**Answer:**
**Piping** is a mechanism to connect output of one stream to another stream. It is normally used to get data from one stream and to pass output of that stream to another stream. There is no limit on piping operations.

**Source:** _tutorialspoint.com_
### Q22: Name some of the events fired by streams. ☆☆☆☆
...
**Source:** _tutorialspoint.com_
### Q23: What is the purpose of __filename variable? ☆☆☆☆

**Answer:**
The `__filename` represents the filename of the code being executed. This is the resolved absolute path of this code file. For a main program this is not necessarily the same filename used in the command line. The value inside a module is the path to that module file.

**Source:** _tutorialspoint.com_
### Q24: How can you listen on port 80 with Node? ☆☆☆☆

**Answer:**
Run the application on any port above 1024, then put a reverse proxy like [nginx](http://nginx.org/) in front of it.

**Source:** _blog.risingstack.com_
### Q25: What tools can be used to assure consistent code style? ☆☆☆☆
...
**Source:** _blog.risingstack.com_
### Q26: What's a stub? Name a use case. ☆☆☆☆
...
**Source:** _blog.risingstack.com_
### Q27: Does Node.js support multi-core platforms? And is it capable of utilizing all the cores? ☆☆☆☆
...
**Source:** _techbeamers.com_
### Q28: Is Node.js entirely based on a single-thread? ☆☆☆☆
...
**Source:** _techbeamers.com_
### Q29: Is Node.js entirely based on a single-thread? ☆☆☆☆
...
**Source:** _techbeamers.com_
### Q30: When to not use Node.js? ☆☆☆☆

**Answer:**
We can use Node.js for a variety of applications. But it is a single threaded framework, so we should not use it for cases where the application requires long processing time. If the server is doing some calculation, it won’t be able to process any other requests. Hence, Node.js is best when processing needs less dedicated CPU time.

**Source:** _techbeamers.com_
### Q31: Why to use Buffers instead of binary strings to handle binary data ? ☆☆☆☆

**Answer:**
Pure JavaScript does not able to handle straight binary data very well. Since Node.js servers have to deal with TCP streams for reading and writing of data, binary strings will become problematic to work with as it is very slow and has a tendency to break. That's why it is always advisable to use Buffers instead of binary strings to handle binary data.

**Source:** _codingdefined.com_
### Q32: How to gracefully Shutdown Node.js Server? ☆☆☆☆
...
**Source:** _codingdefined.com_
### Q33: What are the timing features of Node.js? ☆☆☆☆
...
### Q35: What is LTS releases of Node.js why should you care? ☆☆☆☆
...
**Source:** _github.com/i0natan/nodebestpractices_
### Q36: Provide some example of config file separation for dev and prod environments ☆☆☆☆
...
**Source:** _github.com/i0natan/nodebestpractices_
### Q37: How would you handle errors for async code in Node.js? ☆☆☆☆
...
**Source:** _github.com/i0natan/nodebestpractices_
### Q38: What's the difference between dependencies, devDependencies and peerDependencies in npm package.json file? ☆☆☆☆
...
**Source:** _stackoverflow.com_
### Q39: How do you convert an existing callback API to promises? ☆☆☆☆
...
**Source:** _stackoverflow.com_
### Q40: What are async functions in Node? Provide some examples. ☆☆☆☆
...
### Q41: Consider following code snippet ☆☆☆☆☆
...
**Source:** _codeforgeek.com_
### Q44: What is the difference between process.nextTick() and setImmediate() ? ☆☆☆☆☆

**Answer:**
The difference between `process.nextTick()` and `setImmediate()` is that `process.nextTick()` defers the execution of an action till the next pass around the event loop or it simply calls the callback function once the ongoing execution of the event loop is finished whereas `setImmediate()` executes a callback on the next cycle of the event loop and it gives back to the event loop for executing any I/O operations.

**Source:** _codingdefined.com_
### Q45: How to solve "Process out of Memory Exception" in Node.js ? ☆☆☆☆☆
...
**Source:** _codingdefined.com_
### Q46: Explain what is Reactor Pattern in Node.js? ☆☆☆☆☆
...
### Q47: Explain some Error Handling approaches in Node.js you know about. Which one will you use? ☆☆☆☆☆
...
### Q48: Why should you separate Express 'app' and 'server'? ☆☆☆☆☆
...
**Source:** _github.com/i0natan/nodebestpractices_
### Q49: Rewrite the code sample without try/catch block ☆☆☆☆☆
...
**Source:** _medium.com_
### Q50: How many threads does Node actually create? ☆☆☆☆☆
...
**Source:** _stackoverflow.com_
### Q51: Can Node.js work without V8? ☆☆☆☆
...
**Source:** _nodejs.org_
### Q53: What is the purpose of using hidden classes in V8? ☆☆☆☆☆
...
**Source:** _nodejs.org_
### Q56: How does the cluster module work? What’s the difference between it and a load balancer? ☆☆☆☆
...
### Q58: Why do we need C++ Addons in Node.js? ☆☆☆☆☆
...
**Source:** _nodejs.org_
### Q59: Is it possible to use "Class" in Node.js? ☆☆☆☆
...
**Source:** _stackoverflow.com_
### Q60: Why Node.js devs tend to lean towards the Module Requiring vs Dependency Injection? ☆☆☆☆☆
...
### Q61: Explain the result of this code execution ☆☆☆☆☆
...
### Q62: Explain the result of this code execution ☆☆☆☆☆
...
**Source:** _codementor.io_
### Q63: What will happen when that code will be executed? ☆☆☆☆☆
